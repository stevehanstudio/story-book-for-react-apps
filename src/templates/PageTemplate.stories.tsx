...
StickyHeader.args = {
  type: 'sticky-header',
  children: <DummyComponent>Template with sticky header and navigation items</DummyComponent>,
}
...
Basic.args = {
  type: 'basic',
  children: (
    <DummyComponent>Simple template with scrollable header and navigation items</DummyComponent>
  ),
}
